    ...
    */
    ...
    loop {
        ...
        */
        ...
        karna its not possible dan akan masuk ke `.expect` atau jika menggunakan `match` akan masuk ke arm conditions. karna, `match` dapat digunakan untuk handling error.

        `match` adalah best practice untuk handling error.
        */
